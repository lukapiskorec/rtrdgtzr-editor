...
banner_txt += "\n::::::::::::::::::::::::::::::::::::::::::";
banner_txt += "\n";
banner_txt += "\n     r t r d g t z r - e d i t o r |  { p r o t o c e l l : l a b s }  |  2 0 2 4     \n\n";



//let input_img, frame_to_draw, buffer_frames, squares_nr, gif, canvas, image_border, output_border;
//let thumbnail, thumbnail_scale, output_scale, dropped_image, dropped_file, drop_zone_x, drop_zone_y, monomek;
...
let quality = 10; // corresponds to the number of coefficients being selected, higher is better, 1-10
let quant_f = 1; // additional factor which modifies quantization levels, higher means stronger compression, needs to be >= 1
...
let image_border = [0.15, 0.15]; // in precentage of the image dimensions
