...
// random function for specific implementation
//let effect_seed = $fx.getParam("effect_seed");
//let artwork_seed = $fx.minter + "_seed_" + effect_seed.toString(); // artwork seed is composed of minter wallet address and chosen effect number
let artwork_seed = Math.random();
